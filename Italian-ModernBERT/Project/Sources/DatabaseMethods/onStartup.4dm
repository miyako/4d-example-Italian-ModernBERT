...
$folder:=$homeFolder.folder("Italian-ModernBERT")
$path:="Italian-ModernBERT-base-Q8_0.gguf"
$URL:="keisuke-miyako/Italian-ModernBERT-base-gguf-q8_0"
...
$folder:=$homeFolder.folder("Italian-ModernBERT")
$path:="Italian-ModernBERT-base-onnx-int8"
$URL:="keisuke-miyako/Italian-ModernBERT-base-onnx-int8"
